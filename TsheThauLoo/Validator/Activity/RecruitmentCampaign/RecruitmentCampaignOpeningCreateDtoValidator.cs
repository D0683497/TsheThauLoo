...
{
    public class RecruitmentCampaignOpeningCreateDtoValidator : AbstractValidator<RecruitmentCampaignOpeningCreateDto>
    {
        public RecruitmentCampaignOpeningCreateDtoValidator()
        {
