...
namespace TsheThauLoo.Validator.Activity.Campaign
{
    public class CampaignEditDtoValidator : AbstractValidator<CampaignEditDto>
    {
        public CampaignEditDtoValidator()
        {
            RuleFor(x => x.Title)
