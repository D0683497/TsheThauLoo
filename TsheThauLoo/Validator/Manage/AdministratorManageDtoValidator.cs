...
{
    public class AdministratorManageDtoValidator : AbstractValidator<AdministratorManageDto>
    {
        public AdministratorManageDtoValidator()
        {
            #region UserManage
            ...
            #region AdministratorManage

            RuleFor(x => x.AdministratorConfirmed)
                .Cascade(CascadeMode.Stop)
                .NotNull()
                .WithName("管理員驗證")
                .WithMessage("{PropertyName}是必填的")
                .OverridePropertyName("administratorConfirmed");
