...
{
    public class AdministratorsProfile : Profile
    {
        public AdministratorsProfile()
        {
            #region Administrator 轉換成 AdministratorDto
            ...
            #region AdministratorManageDto 轉換成 Administrator

            CreateMap<AdministratorManageDto, Administrator>()
