...
{
    public class ExaminersProfile : Profile
    {
        public ExaminersProfile()
        {
            #region Examiner 轉換成 ExaminerDto
            ...
            #region ExaminerManageDto 轉換成 Examiner

            CreateMap<ExaminerManageDto, Examiner>()
